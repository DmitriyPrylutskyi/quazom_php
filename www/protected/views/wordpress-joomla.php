    ...
    <div id="home" class="hero-area home-1">
        <div class="hero-area-content">
            ...
            <div class="hero-area-content-inner">
                <div class="container">
                    <div class="row">
                        <img src="/img/cms.png" alt="<?=$this->t('app', 'корпоративный сайт')?>">
                        <h1 class="text-center"><?=$this->t('app', 'Сделаем сайт на Вашем любимом движке')?></h1>
                        <h3 class="text-center"><?=$this->t('app', 'Мощные Wordpress, Joomla, Opencart всегда ждут Ваших сложных задач!')?></h3>
						<div class="row">
							<form action="/call.php" method="post" id="contact-form-call" class="col-xs-12 col-md-8 col-md-offset-2" >
                                ...
                                <button type="submit" class="btn btn-default btn-blue-fill-radius"><i class="fa fa-phone"></i><?=$this->t('app', 'Закажите Ваш Корпоративный сайт')?></button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-10 col-sm-offset-1">
                    <div class="section-title-1">
                        <h2 class="title wow fadeInDown"><?=$this->t('app', 'Почему мы это делаем хорошо?')?></h2>
                    </div>
                </div>
            </div>
            <div class="row block">
                <div class="col-xs-12 col-sm-2 img wow fadeInLeft" data-wow-delay="0.2s">
                    <img src="/img/svg/cms-reason-1.svg" alt="<?=$this->t('app', 'сайт на wordpress')?>">
                </div>
                <div class="col-xs-12 col-sm-10 body wow fadeInRight" data-wow-delay="0.2s">
                    <p><?=$this->t('app', 'Мы заинтересованы создать Вам качественный фирменный сайт. Он станет Вашим солидным ресурсом для презентации Вас или Вашей компании партнерам и клиентам. С помощью корпоративного сайта Вы сможете управлять всей структурой фирмы, а также своей базой клиентов.')?></p>
                </div>
            </div>
            <div class="row block">
                <div class="col-xs-12 col-sm-10 body wow fadeInLeft" data-wow-delay="0.2s">
                    <p><?=$this->t('app', 'Мы поможем подобрать или разработать фирменный стиль для сайта Вашей компании, который Вы затем используете и в корпоративной полиграфии. Также Ваш ресурс позволит держать Ваших клиентов в курсе событий с помощью новостей, анонсов, статей и рассылки почтовых отправлений.')?></p>
                </div>
                <div class="col-xs-12 col-sm-2 text-right img wow fadeInRight" data-wow-delay="0.2s">
                    <img src="/img/svg/cms-reason-2.svg" alt="<?=$this->t('app', 'сайт на joomla')?>">
                </div>
            </div>
            <div class="row block">
                <div class="col-xs-12 col-sm-2 img wow fadeInLeft" data-wow-delay="0.2s">
                    <img src="/img/svg/cms-reason-3.svg" alt="<?=$this->t('app', 'сайт на opencart')?>">
                </div>
                <div class="col-xs-12 col-sm-10 body wow fadeInRight" data-wow-delay="0.2s">
                    <p><?=$this->t('app', 'Мы решим все вопросы с подбором, оформлением Вашего имени домена, размещением сайта на надежном и удобном Вам хостинге. Мы обеспечим Ваш сайт технической поддержкой первый месяц после старта. При необходимости поможем с презентацией Вашего сайта.')?></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row block">
                ...
                <div class="col-sm-10 col-md-11 body wow fadeInRight" data-wow-delay="0.2s">
                    <p><?=$this->t('app', 'Вы скачиваете и заполняете Анкету для создания Вашего корпоративного сайта, затем отправляете нам. Мы можем в этом Вам помочь.')?></p>
                </div>
            </div>
            <div class="row block">
                ...
                <div class="col-sm-9 col-md-10 body wow fadeInRight" data-wow-delay="0.2s">
                    <p><?=$this->t('app', 'Мы вместе обсуждаем Анкету и задачи Вашего сайта, подбираем дизайн и структуру, заключаем договор и оформляем предоплату.')?></p>
                </div>
            </div>
            <div class="row block">
                ...
                <div class="col-sm-8 col-md-9 body wow fadeInRight" data-wow-delay="0.2s">
                    <p><?=$this->t('app', 'Мы создаем прототип Вашего будущего корпоративного сайта. Вы вносите предложения по редактированию прототипа.')?></p>
                </div>
            </div>
            <div class="row block">
                <div class="col-sm-8 col-md-9 body wow fadeInLeft" data-wow-delay="0.2s">
                    <p><?=$this->t('app', 'После корректировки прототипа, Вы принимаете окончательный вариант. Мы начинаем разрабатывать и настраивать Ваш будущий сайт.')?></p>
                </div>
            ...
            <div class="row block">
                <div class="col-sm-9 col-md-10 body wow fadeInLeft" data-wow-delay="0.2s">
                    <p><?=$this->t('app', 'После создание мы тестируем работоспособность готового сайта. Вместе обсуждаем и подбираем свободное имя домена.')?></p>
                </div>
                <div class="col-sm-2 col-md-1 img wow fadeInRight" data-wow-delay="0.2s">
            ...
            <div class="row block">
                <div class="col-sm-10 col-md-11 body wow fadeInLeft" data-wow-delay="0.2s">
                    <p><?=$this->t('app', 'После полной оплаты нашей работы мы выкладываем Ваш сайт на выбранный Вами домен и хостинг. Вы запускаете пиар-компанию Вашего сайта.')?></p>
                </div>
                <div class="col-sm-2 col-md-1 img wow fadeInRight" data-wow-delay="0.2s">
